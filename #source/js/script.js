...
*/
/*//const mainForm = document.forms;                 //константа для нашей формы
...
const nameInput = mainForm.name;   //константа для input с именем name
const namePlaceholder = nameInput.placeholder; //константа для placeholder в указанном input
const companyInput = mainForm.comName;   //константа для input с именем name
const companyPlaceholder = companyInput.placeholder; //константа для placeholder в указанном input
const emailInput = mainForm.email; //константа для input с именем email
const emailPlaceholder = emailInput.placeholder; //константа для placeholder в указанном input
...
/*placeholder.forEach(el => //для всех placeholder мы
	el.addEventListener("blur", function (element) { //при событии blur - это когда вышли из фокуса
		nameInput.placeholder = placeholder.value = "Name";  //возвращаем исходный placeholder
		companyInput.placeholder = placeholder.value = "Company name";
		emailInput.placeholder = placeholder.value = "Email"; //возвращаем исходный placeholder
	}));*/
/*
//ZOOM
if ($('.gallery').length > 0) {
